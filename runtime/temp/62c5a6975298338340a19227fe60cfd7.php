<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\EProject\wwwroot\tests\public\..\application\admin\view\tests\addtest1.html";i:1480942811;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <form method="post" class="form-x" enctype="multipart/form-data" action="<?php echo url('tests/addTest1'); ?>">
      ...
      <div class="form-group">
        ...
        <div class="field" style="padding-top:8px;">
          正确 <input id="r" name="answer"  value="1" type="radio" />
          错误 <input id="w" name="answer"  value="0" type="radio" />
